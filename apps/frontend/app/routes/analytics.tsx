...
import { divisionListResponseSchema, type Division } from "~/lib/schemas/divisions";
  ...
  return (
    <Stack spacing={2}>
      ...
      <Typography variant="body1" color="text.secondary">
        Consolidated view of event volume, lifecycle state mix, and recent match activity from projection-backed
        analytics.
      </Typography>
        ...
        <>
          ...
          <Grid container spacing={2}>
            ...
            <Grid item xs={12} md={4}>
              <Card>
                <CardContent>
                  <Typography variant="overline">Transition Events</Typography>
            ...
            <Grid item xs={12} md={4}>
              <Card>
                <CardContent>
                  <Typography variant="overline">Score Events</Typography>
          ...
          <Grid container spacing={2}>
            <Grid item xs={12} md={6}>
              <Card>
                <CardContent>
                  <Typography variant="overline">Peak Hourly Volume</Typography>
                  <Typography variant="h5">
                    {peakTrendBucket ? peakTrendBucket.total_events : 0}
                  </Typography>
            ...
            <Grid item xs={12} md={6}>
              <Card>
                <CardContent>
                  <Typography variant="overline">Active Roles</Typography>
